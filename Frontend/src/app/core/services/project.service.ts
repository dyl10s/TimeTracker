...
export class ProjectService {
  ...
  public getProjectsByUser(activeOnly: string) : Observable<GenericResponseDTO<any>> {
    return this.http.get<GenericResponseDTO<any>>(`${this.api}/Project/Bool`, { params: { activeOnly: activeOnly} });
  }
